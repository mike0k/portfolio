...
<div id="footer">
  ...
  <a target="_blank" href="http://validator.w3.org/check?uri=http://www.michaelkirkbright.co.uk">
  ...
  <div class="browserScrape">
    ...
    <?php
		...
		echo'
		<h5>Browser Usage - '.$lastmonthTxt.'</h5>
		<table>
			<tr>
		...
		define('ga_password','juejveufgr2611');
