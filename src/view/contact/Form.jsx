...
const VForm = () => {
    const status = useSelector((state) => state.layout.contactForm);
    ...
    return (
        <Drawer
            ...
            <Box sx={sx.closeBox}>
                <Btn onClick={onClose} sx={sx.close} color='light' icon={false}>
                    <MdOutlineHorizontalRule />
                </Btn>
            </Box>
            <GoogleReCaptchaProvider reCaptchaKey={Config.api.recaptcha}>
